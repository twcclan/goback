...
func (m *HasRequest) String() string            { return proto1.CompactTextString(m) }
func (*HasRequest) ProtoMessage()               {}
func (*HasRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{8} }
...
func (m *HasResponse) String() string            { return proto1.CompactTextString(m) }
func (*HasResponse) ProtoMessage()               {}
func (*HasResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{9} }
...
func init() {
	...
	proto1.RegisterType((*HasRequest)(nil), "proto.HasRequest")
	proto1.RegisterType((*HasResponse)(nil), "proto.HasResponse")
}
...
func (c *storeClient) Has(ctx context.Context, in *HasRequest, opts ...grpc.CallOption) (*HasResponse, error) {
	out := new(HasResponse)
	err := grpc.Invoke(ctx, "/proto.Store/Has", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
