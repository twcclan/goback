...
var (
	transactionAllColumns            = []string{"id", "status", "created_at", "updated_at"}
	transactionColumnsWithoutDefault = []string{"id", "status", "created_at"}
	transactionColumnsWithDefault    = []string{"updated_at"}
