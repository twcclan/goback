...
var TreeWhere = struct {
	...
	SetID: whereHelperint{field: "\"trees\".\"set_id\""},
}
...
type (
	...
	// This should generally be used opposed to []Tree.
	TreeSlice []*Tree
...
func FindTree(ctx context.Context, exec boil.ContextExecutor, ref []byte, path string, setID int, selectCols ...string) (*Tree, error) {
	treeObj := &Tree{}
...
func TreeExists(ctx context.Context, exec boil.ContextExecutor, ref []byte, path string, setID int) (bool, error) {
	var exists bool
