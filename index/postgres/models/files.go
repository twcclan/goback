...
var FileWhere = struct {
	...
	SetID:     whereHelperint{field: "\"files\".\"set_id\""},
	Ref:       whereHelper__byte{field: "\"files\".\"ref\""},
	Mode:      whereHelperint{field: "\"files\".\"mode\""},
...
func FindFile(ctx context.Context, exec boil.ContextExecutor, path string, timestamp time.Time, setID int, selectCols ...string) (*File, error) {
	fileObj := &File{}
...
func FileExists(ctx context.Context, exec boil.ContextExecutor, path string, timestamp time.Time, setID int) (bool, error) {
	var exists bool
